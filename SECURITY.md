...
- GitHub Security Advisories (preferred): `https://github.com/argvus/argvus-control-center/security/advisories/new`
- Otherwise, contact the maintainers directly.

Please include:

1. Affected version/tag and package name (`argvus-control-center`)
